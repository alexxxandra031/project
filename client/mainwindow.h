...
private:
    ...
    // Объединённые версии addMessage (настя)
    void addMessage(const QString &sender, const QString &text, const QString &time, bool isOutgoing);
    void addMessage(const char *sender, const char *text, bool isOutgoing);
