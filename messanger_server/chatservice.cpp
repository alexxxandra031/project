...
QString ChatService::getChatInfo(int userId, int chatId)
{
    ...
    if(DatabaseManager::getInstance()->getChatParticipantsUsernames(chatId, users) != DatabaseManager::DB_OK)
...
QString ChatService::addUserToChat(int chatId, const QString& username, int requesterId)
{
    ...
    DatabaseManager::DbResult res = DatabaseManager::getInstance()->addUserToChat(chatId, userId, "member");
    switch(res) {
    case DatabaseManager::DB_OK:
        qDebug() << "[ADD_USER OK]";
...
QString ChatService::removeUserFromChat(int chatId, const QString& username, int requesterId)
{
    ...
    DatabaseManager::DbResult res = DatabaseManager::getInstance()->removeUserFromChat(chatId, userId);
    if(res != DatabaseManager::DB_OK)
